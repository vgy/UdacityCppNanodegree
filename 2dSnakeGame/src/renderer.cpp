...
void Renderer::Render(Snake const snake, SDL_Point const &food) const {
  SDL_Rect block;
...
void Renderer::UpdateWindowTitle(int fps, std::shared_ptr<Player> player, std::shared_ptr<Player> top_player) const {
